...
int main(int argv, char** argc) {
  ...
  (void)col_id;
  (void)cell_id;  // clear Unused Var warning;
  ...
  MPI_Allreduce(&my_cell_count, &total_cell_count, 1, MPI_LONG_LONG, MPI_SUM,
                MPI_COMM_WORLD);
  MPI_Allreduce(&my_col_count, &total_column_count, 1, MPI_LONG_LONG, MPI_SUM,
                MPI_COMM_WORLD);
